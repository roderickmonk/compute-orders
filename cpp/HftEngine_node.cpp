...
static void HftEngineAsyncComplete(uv_work_t *req, int status)
{
  ...
  Local<Object> buyOrder = Object::New(isolate);
  buyOrder->Set(String::NewFromUtf8(isolate, "Buy"), Number::New(isolate, work->nextOrders.first));
  result_list->Set(0, buyOrder);
  Local<Object> sellOrder = Object::New(isolate);
  buyOrder->Set(String::NewFromUtf8(isolate, "Sell"), Number::New(isolate, work->nextOrders.second));
  result_list->Set(1, sellOrder);
